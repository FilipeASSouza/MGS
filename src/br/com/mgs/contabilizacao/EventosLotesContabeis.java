...
public class EventosLotesContabeis implements EventoProgramavelJava {

    RegrasContabeis regrasContabeis = new RegrasContabeis();
    ...
    public void beforeUpdate(PersistenceEvent persistenceEvent) throws Exception {
        regrasContabeis.permissaoAlteracao(persistenceEvent);
    }
